...
const HISTORY = [
  // MARCH
  {
    ...
    skus: ['APP-005', 'APP-006'], stores: ['MUM-1', 'DEL-2'], loss: '₹2.1L',
    what: 'Apparel items APP-005 and APP-006 ran completely out of stock at Mumbai and Delhi stores — 2 weeks before the season even ended. Customers came in to buy but shelves were empty. The reason was Holi shopping — people bought much more than usual and the stores were not prepared with enough stock.',
  ...
  },
  {
    ...
    skus: ['FOO-010', 'FOO-011'], stores: ['BLR-3', 'HYD-5'], loss: '₹3.4L',
    what: 'More than half the Footwear stock at Bangalore and Hyderabad stores was left unsold at the end of March. Too many items were ordered but customers did not buy them. The store had to sell them at a big discount later just to clear the shelves, which cost ₹3.4L in lost margin.',
  ...
  },
  {
    ...
    skus: ['HOM-001', 'HOM-002', 'HOM-003'], stores: ['MUM-1', 'DEL-2', 'CHN-4'], loss: '₹1.8L',
  ...
  },
  {
    ...
    skus: ['APP-007', 'APP-008'], stores: ['MUM-1', 'CHN-4'], loss: '₹2.6L',
    what: 'Two stores had opposite problems with the same Apparel items. Mumbai store ran out of APP-007 completely — customers wanted it but it was gone. Chennai store had too much APP-008 left over that nobody was buying. This mismatch caused a combined loss of ₹2.6L.',
  ...
  },
  {
    ...
    skus: ['APP-005', 'APP-006', 'APP-007'], stores: ['MUM-1', 'DEL-2'], loss: '₹4.2L',
    what: 'This happened for the 4th year in a row — Apparel at Mumbai and Delhi ran out of stock 18 days early in March. APP-005, APP-006 and APP-007 were all empty by March 12th. Customers were still coming in to buy but there was nothing to sell. Same problem, same stores, same month, every year.',
  ...
  // MAY
  {
    ...
    skus: ['FOO-003', 'FOO-004'], stores: ['BLR-3', 'CHN-4', 'HYD-5'], loss: '₹2.8L',
    what: 'Almost half of all Footwear ordered for May was still sitting unsold in the stores at the end of the month. Three stores — Bangalore, Chennai and Hyderabad — all had the same problem. The stock just did not move and the stores had to take a loss to clear it.',
  ...
  },
  {
    ...
    skus: ['HOM-004', 'HOM-005'], stores: ['MUM-1'], loss: '₹1.2L',
    what: 'Home items HOM-004 and HOM-005 sold out very quickly at Mumbai in the middle of May. This happened because of the wedding season — many customers were buying home items as gifts. The store ran out and missed sales for the rest of the month.',
  ...
  },
  {
    ...
    skus: ['APP-002', 'APP-004', 'APP-008'], stores: ['DEL-2', 'BLR-3', 'HYD-5'], loss: '₹5.1L',
    ...
    fix: 'Before ordering Apparel for May, check how fast each item was selling in April. If an item was barely moving, order very little of it — not a full shelf. A few items that go unsold cost more than having a small gap on the shelf.',
  },
  {
    month: 5, year: 2024, type: 'mixed', category: 'Footwear', icon: '⚠️',
    skus: ['FOO-001', 'FOO-002'], stores: ['MUM-1', 'DEL-2', 'BLR-3', 'CHN-4', 'HYD-5'], loss: '₹4.0L',
    what: 'FOO-001 sold out completely at big city stores by May 20th while FOO-002 had large amounts left over at every store. One item had no stock, the other had too much — at the same time, across all stores. This mismatch led to missed sales and wasted stock.',
    fix: 'When one item runs out at a store, check if another nearby store has extra. Move the stock over instead of letting one store sit empty and another store sit on too much. This should be checked every 2 weeks.',
  },
  {
    month: 5, year: 2025, type: 'overstock', category: 'Footwear', icon: '📦',
    skus: ['FOO-013', 'FOO-014', 'FOO-015'], stores: ['BLR-3', 'CHN-4', 'HYD-5'], loss: '₹6.8L',
    what: 'Three Footwear items were heavily discounted in the final 5 days of May to clear the leftover stock. Because discounts were given so late and so large, the stores lost ₹6.8L in margin. The items were not selling all month but no action was taken until it was too late.',
  ...
  // AUGUST
  {
    ...
    skus: ['HOM-006', 'HOM-007'], stores: ['MUM-1', 'DEL-2'], loss: '₹1.4L',
    what: 'Home items HOM-006 and HOM-007 were completely sold out within just 10 days at Mumbai and Delhi. Independence Day (Aug 15) brought in many customers buying gifts for family and friends. The stores were not ready with enough stock and lost sales for the rest of the month.',
  ...
  },
  {
    ...
    skus: ['APP-010', 'APP-011', 'APP-016'], stores: ['CHN-4', 'HYD-5'], loss: '₹4.8L',
  ...
  },
  {
    ...
    skus: ['APP-001', 'APP-005', 'APP-006'], stores: ['MUM-1', 'DEL-2', 'CHN-4'], loss: '₹3.7L',
    what: 'Apparel ran out of stock at 3 stores in August. Both Onam shopping and back-to-school buying happened at the same time — double the usual demand. Mumbai store ran out completely within 11 days. Lost ₹3.7L in missed sales.',
  ...
  },
  {
    ...
    skus: ['FOO-005', 'FOO-006', 'FOO-007'], stores: ['MUM-1', 'DEL-2', 'BLR-3'], loss: '₹3.2L',
  ...
  },
  {
    ...
    skus: ['HOM-001', 'HOM-002', 'HOM-003', 'HOM-004'], stores: ['MUM-1', 'DEL-2', 'BLR-3'], loss: '₹2.9L',
  ...
  // OCTOBER
  {
    ...
    skus: ['APP-001', 'APP-003', 'APP-005'], stores: ['MUM-1', 'DEL-2'], loss: '₹3.1L',
  ...
  },
  {
    ...
    skus: ['HOM-008', 'HOM-009', 'HOM-010'], stores: ['BLR-3', 'HYD-5'], loss: '₹3.9L',
  ...
  },
  {
    ...
    skus: ['FOO-001', 'FOO-002', 'FOO-003'], stores: ['MUM-1', 'DEL-2', 'CHN-4'], loss: '₹4.4L',
  ...
  },
  {
    ...
    skus: ['APP-002', 'FOO-008', 'FOO-009'], stores: ['MUM-1', 'DEL-2', 'BLR-3', 'CHN-4', 'HYD-5'], loss: '₹5.2L',
  ...
  },
  {
    ...
    skus: ['APP-001', 'APP-003', 'FOO-001', 'FOO-002'], stores: ['MUM-1', 'DEL-2', 'CHN-4'], loss: '₹6.1L',
...
function detectLiveMatch(event, recs) {
  ...
  const skuHit = atRisk.filter(r => event.skus.includes(r.sku))
  if (skuHit.length > 0) {
    const names = [...new Set(skuHit.map(r => r.sku))]
    return { level: 'sku', names }
  }
  const catHit = atRisk.filter(r => r.category && event.category.includes(r.category))
  if (catHit.length > 0) return { level: 'cat', count: catHit.length, cat: catHit[0].category }
  return null
}
...
function EventRow({ ev, recs, isLast }) {
  ...
  return (
    <div className="hi-ev-row" style={{ borderLeftColor: isLast ? 'transparent' : tc.border }}>
      ...
      {/* live match warning */}
      {match && match.level === 'sku' && (
        <div className="hi-ev-live hi-ev-live-red">
          ⚡ Same SKU{match.names.length > 1 ? 's' : ''} at risk right now: <strong>{match.names.join(', ')}</strong> — this pattern is repeating!
        </div>
      )}
      {match && match.level === 'cat' && (
        <div className="hi-ev-live hi-ev-live-amber">
          ⚠ {match.cat} has {match.count} Red/Amber SKU{match.count > 1 ? 's' : ''} currently — same category pattern as {ev.year}
        </div>
      )}

      {/* SKU tags */}
      <div className="hi-ev-skus">
        {ev.skus.map(s => (
          <span key={s} className="hi-ev-sku" style={{ color: tc.color, borderColor: tc.border }}>{s}</span>
        ))}
        <span className="hi-ev-stores">@ {ev.stores.join(', ')}</span>
      </div>
